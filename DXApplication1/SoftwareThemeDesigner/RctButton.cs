...
namespace SoftwareThemeDesigner
{
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:SoftwareThemeDesigner"
	///
	///
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:SoftwareThemeDesigner;assembly=SoftwareThemeDesigner"
	///
